#!/usr/bin/env python3
"""
Recupero codici sconto Mondadori Store da shopilo.it
Sursa: https://shopilo.it/negozi/mondadoristore.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/mondadoristore.it"
STORE_NAME = "Mondadori Store"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Mondadori Store da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-mondadori)"
    }
    try:
